...
require_once 'Reports/Reports/ServantsGeneralReport.php';

class ServantsGeneralController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
    protected $_processoAp = 999731;
    ...
    /**
     * @return ServantsGeneralReport
     *
     * @throws Exception
     */
    public function report()
    {
        return new ServantsGeneralReport();
    }
}
