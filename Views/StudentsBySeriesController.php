...
require_once 'Reports/Reports/StudentsBySeriesReport.php';

class StudentsBySeriesController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @inheritdoc
     */
    protected $_processoAp = 9999202;

    /**
     * @var string
     */
    protected $_titulo = 'Alunos matriculados por série';
    ...
    {
        return new StudentsBySeriesReport();
    }
}
