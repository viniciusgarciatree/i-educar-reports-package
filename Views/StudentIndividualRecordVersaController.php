...
require_once 'Reports/Reports/StudentIndividualRecordVersaReport.php';

class StudentIndividualRecordVersaController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
