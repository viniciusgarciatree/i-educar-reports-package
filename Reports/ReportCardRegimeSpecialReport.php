...
class ReportCardRegimeSpecialReport extends Portabilis_Report_ReportCore
{
    use JsonDataSource;
    ...
    {
        return 'report-card-regime-special';
    }
...
//        $dados   = Portabilis_Utils_Database::fetchPreparedQuery($this->getSqlMainReport());
//
//
//        $arrNota = [];
//        $arrMain = [];
...
//        unset($this->args['instituicao']);
//        unset($this->args['escola']);
//        unset($this->args['curso']);
//        unset($this->args['serie']);
//        unset($this->args['turma']);
//        unset($this->args['ano']);
//        unset($this->args['situacao_matricula']);
//        unset($this->args['alunos_diferenciados']);
