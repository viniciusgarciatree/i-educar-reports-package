...
class StudentsByRelativesController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    protected $_titulo = 'Relatório de dados familiares do aluno';
    ...
    protected function _preRender()
    {
        ...
        $this->breadcrumb('Relatório de dados familiares do aluno', [
